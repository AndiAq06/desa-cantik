...
export default function VillageDetail() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div className="bg-gradient-to-br from-white to-blue-50/20 p-5 rounded-2xl border border-blue-100/50 shadow-sm hover:shadow-md transition-all duration-300 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-lg sm:text-2xl font-black bg-gradient-to-r from-[#154D71] to-[#1C6EA4] bg-clip-text text-transparent break-all">{village.village_code || "-"}</p>
                    </div>
                  </div>
                </div>
              </ScrollReveal>
      ...
      {/* PETA TEMATIK */}
      <section id="peta" className="relative min-h-[calc(100vh-80px)] flex flex-col justify-center sm:justify-start bg-gray-50 py-8 sm:pt-12 sm:pb-16">
        <div className="container mx-auto px-6 w-full">
          <ScrollReveal>
            <div className="mb-6">
          ...
          <div className="relative w-full rounded-2xl shadow-xl overflow-hidden border-4 border-white group h-[480px] sm:h-[500px] md:h-[540px] lg:h-[580px] xl:h-[640px] max-h-[70vh]">
